      ...
      $.ajax({
        ...
        success: function (data) {
          ...
          if (data.msg.status == 'enable') {
            $.growl.active({
                title: "Class/Course",
                message: "Class/Course Active!"
            });
        }
        else {
          $.growl.inactive({
              title: "Class/Course",
              message: "Class/Course Inactive!"
          });
        }
      ...
      <div class="col-12">
        ...
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">Class/Course List</h3>
  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Add Class/Course</h4>
      </div>
...
<div id="myModal1" class="modal fade" role="dialog" style="z-index:99999999999;">
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Edit Class/Course</h4>
      </div>
      <div class="modal-body">
