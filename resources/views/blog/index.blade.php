          ...
          <div class="card-body">
            <table id="example1" class="table table-responsive table-bordered table-striped">
              ...
              <tbody>
                ...
                <tr>
                  <td>{{$i++}}</td>
                  <td><img src="uploads/blog/{{$item->image}}" style="width:100px; height: 100px;"></td>
                  <td>{{$item->title}}</td>
    ...
    $(".mybtn1").click(function () {
      ...
      $.ajax({
        ...
        success: function (data) {
          ...
          $("#short_description").val(data.msg.short_description);
          $("#full_description").val(data.msg.full_description);
        }
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              <div class="form-group">
                ...
                <textarea type="text" placeholder="Full Description" class="form-control"
            ...
            <div class="col-md-6">
              <div class="form-group">
                <label>Image</label>
                <input type="file" placeholder="Image" class="form-control" name="image" id="image"
...
<div id="myModal1" class="modal fade" role="dialog" style="z-index:99999999999;">
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="/blog_update" method="POST" enctype="multipart/form-data">
          @csrf
          <div class="row">
            ...
            <div class="col-md-8">
              <div class="form-group">
                <label>Full Description</label>
                <input type="text" placeholder="Full Description" class="form-control" name="full_description"
                  id="full_description">
              </div>
            </div>
