          ...
          <div class="card-body">
            <table id="example1" class="table table-responsive table-bordered table-striped">
              ...
              <tbody>
                ...
                <tr>
                  <td>{{$i++}}</td>
                  <td><img src="uploads/team/{{$item->image}}" style="width:100px; height: 100px;"></td>
                  <td>{{$item->name}}</td>
          ...
          <div class="row">
            ...
            <div class="col-md-12">
             ...
             <div class="col-md-12">
              <div class="form-group">
                <label>Designation</label>
                <input type="text" placeholder="Designation" class="form-control" name="designation" id="name">
              </div>
            </div>
             <div class="col-md-12">
              <div class="form-group">
