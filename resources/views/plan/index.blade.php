                ...
                <tr>
                  ...
                  <td>
                    <div class="btn-group">
                      ...
                      <form action="{{ route('plan.destroy', $item->id) }}" method="POST">
                        @method('DELETE')
                        @csrf
    ...
    $(".mybtn1").click(function () {
      ...
      $.ajax({
        ...
        success: function (data) {
          ...
          $("#myModal1").modal('show');
          $("#id").val(data.msg.id);
          $("#plan_user_type").val(data.msg.plan_user_type);
          $("#plan_name").val(data.msg.plan_name);
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                <label>Plan User Type</label>
                    <select class="form-control" aria-label="Default select example" name="plan_user_type">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" placeholder="Title" class="form-control" name="plan_name" required>
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
            ...
            <div class="col-md-12">
              <div class="form-group">
                ...
                <textarea type="text" placeholder="Description" class="form-control" name="description"></textarea>
              </div>
            </div>
...
<div id="myModal1" class="modal fade" role="dialog" style="z-index:99999999999;">
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="/plan_update" method="POST" enctype="multipart/form-data">
          @csrf
          <div class="row">
            ...
            <div class="col-md-12">
              <div class="form-group">
                <label>Plan User Type</label>
                    <select class="form-control" aria-label="Default select example" name="plan_user_type">
                      <option selected="">Select Plan</option>
                     <option value="student" @if($item->plan_user_type == 'student'){{"selected"}} @endif>Student</option>
                        <option value="teacher" @if($item->plan_user_type == 'teacher'){{"selected"}} @endif>Teacher</option>
                    </select>
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label>Plan Name</label>
                <input type="text" placeholder="Title" class="form-control" name="plan_name" id="plan_name">
              </div>
            </div>
             <div class="col-md-6">
              <div class="form-group">
                <label>Amount</label>
                <input type="text" placeholder="Title" class="form-control" name="amount" id="amount">
              </div>
            </div>
            <div class="col-md-12">
              <div class="form-group">
                <label>Description</label>
                <textarea type="text" placeholder="Description" class="form-control" name="description" id="description"></textarea>
              </div>
            </div>
            <div class="col-md-6">
              <button type="submit" name="submit" class="btn btn-primary">Submit</button>
