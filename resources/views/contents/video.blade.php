        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="/get_video_content/{{$chapter->id}}" class="btn btn-primary1 btn-info">Video</a>
                    <a href="/get_pdf_content/{{$chapter->id}}" class="btn btn-primary1 btn-info1">PDF</a>
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        @foreach($data as $item)
                            <tr> 
                	            ...
                	            <td style="padding-top: 7%;"><a href="{{$item->url}}" target="blank">{{$item->title}}</a></td>
                	            <td><iframe width="100%" height="150px" src="{{$item->url}}"></iframe></td>
            ...
            <div class="modal-body">
                ...
                @csrf
                    ...
                    <div class="form-group">   
                        <label label="name" >Video Title</label>
                        <input type="text" placeholder="Video Title" class="form-control" name="title" required>
                    </div>
                     </div>
                    <div class="col-md-12">
                         
                    <div class="form-group">   
                        <label label="name" >Video URL</label>
                        <input type="text" placeholder="Video URL" class="form-control" name="url" required>
                    </div>
                     </div>
            ...
            <div class="modal-body">
                ...
                @csrf
                    ...
                    <div class="form-group">   
                        ...
                        <input type="text" placeholder="your name" class="form-control" id="url" name="url">
                    </div>
                     </div>
