...
<script>
  $(function () {
    $('.tog').change(function () {
      ...
      $.ajax({
        type: 'POST',
        url: '/update_status_specilization',
        data: {
          _token: '{{ csrf_token() }}',
          stat: state,
          id: c
        ...
        success: function (data) {
          ...
          if (data.msg.status == 'enable') {
            $.growl.active({
                title: "Specilization",
                message: "Specilization Active!"
            });
        }
        else {
          $.growl.inactive({
              title: "Specilization",
              message: "Specilization Inactive!"
          });
        }
      ...
      <div class="col-12">
        ...
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">Specilization List</h3>
                ...
                <tr>
                  ...
                  <td>
                    <div class="btn-group">
                      ...
                      <form action="{{ route('specilization.destroy', $item->id) }}" method="POST">
                        @method('DELETE')
                        @csrf
  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Add Specilization</h4>
      </div>
      <div class="modal-body">
        <form action="{{route('specilization.store')}}" method="POST" enctype="multipart/form-data">
          @csrf
          <div class="row">
            <div class="col-md-12">
...
<div id="myModal1" class="modal fade" role="dialog" style="z-index:99999999999;">
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Edit Specilization</h4>
      </div>
      <div class="modal-body">
        <form action="/specilization_update" method="POST" enctype="multipart/form-data">
          @csrf
          <div class="row">
