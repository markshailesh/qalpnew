                    ...
                    <div class="card-body">
                        <table id="example1" class="table table-responsive table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{$i++}}</td>
                                    <td><img id="blah" src="{{ URL::asset('public/uploads/slider/'.$item->image)  }}"
                                            alt="your image" style="height:50px;width:100px;" /></td>
                                    <td> <label class="switch">
                                            <input type="checkbox" class="tog" data-toggle="toggle"
                                                value="{{$item->id}}" @if($item->status=='enable') {{$checked}} else
                                            {{$unchecked}} @endif >
        ...
        $(".mybtn1").click(function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $("#blah2").attr('src', '/public/uploads/slider/' + data.msg.image);
                    ...
                    <div class="row">
                          <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <img id="blah1" src="/public/uploads/no-image.png" alt="your image" /
                                    style="height: 100px;width: 180px; box-shadow: 0 0 4px #00000057;">
                                <i style="font-size:24px;position: absolute;margin-left: -9px;margin-top: -11px;color: red;"
                                    class="fa" type="button" onclick="ClearFields();">&#xf00d;</i>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
...
<div id="myModal1" class="modal fade" role="dialog" style="z-index:99999999999999999999;">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/slider_update" method="POST" enctype="multipart/form-data">
                    @csrf
                        ...
                        <input type="hidden" id="id" name="id">
                          <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <img id="blah2" src="/public/uploads/no-image.png" alt="your image" /
                                    style="height: 100px;width: 180px; box-shadow: 0 0 4px #00000057;">
                                <i style="font-size:24px;position: absolute;margin-left: -9px;margin-top: -11px;color: red;"
                                    class="fa" type="button" onclick="ClearFields();">&#xf00d;</i>
                            </div>
